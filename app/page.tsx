...
const slides: Slide[] = [
  {
    id: 1,
    image: 'https://res.cloudinary.com/degalhtre/image/upload/v1777295055/hero-bg_iqfcsi.jpg',
    title: 'Le luxe dans chaque regard',
    subtitle: 'Extensions de cils haut de gamme',
  },
  {
    id: 2,
    image: 'https://res.cloudinary.com/degalhtre/image/upload/v1778145275/pexels-svliiim-34997577_1_p7agvr.jpg',
    title: 'L\'exception pour vos cils... et vos ongles aussi. ',
    subtitle: 'O',
  },
]
    ...
    <>
      ...
      <main className="overflow-hidden">
        ...
        <div className="hero-section" style={{ height: '100vh', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          {/* Contenu - Animation du texte aussi */}
          <div 
            style={{ 
              position: 'relative', 
              zIndex: 10, 
        ...
        {/* Ajoute les animations CSS dans un style tag */}
        <style>{`
          @keyframes fadeInUp {
            from {
              opacity: 0;
        ...
        <section className="prestations-section">
          ...
          <div className="sr-only">
            <h3>Cil à cil</h3>
            <p>Prix : 60 000 Ar</p>
            <p>Naturel & raffiné. Une pose légère et élégante pour un résultat subtil.</p>
            
            <h3>Hybride</h3>
            <p>Prix : 70 000 Ar</p>
            <p>Équilibre parfait. Allie des extensions classiques et des bouquets de volume.</p>
            
            <h3>Volume Brésilien</h3>
            <p>Prix : 80 000 Ar</p>
            <p>Douceur et intensité. Un volume structuré pour un regard intense mais élégant.</p>
            
            <h3>Mégavolume</h3>
            <p>Prix : 100 000 Ar</p>
            <p>Glamour et sophistiqué. Un volume dense pour un effet glamour marqué.</p>
          </div>
          <div className="prestations-grid">
            ...
            {loading ? (
              ...
              services.map((service) => (
                <div key={service.id} className="prestation-card">
                  <div className="prestation-image-wrapper">
                    ...
                    <div className="prestation-image-text">
                      <h4 className="prestation-image-title">{service.name}</h4>
                      <p className="prestation-image-subtitle">
                        {service.description?.substring(0, 30) || 'Prestation sur-mesure'}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="ouverture-section">
          <div className="ouverture-card">
            ...
            <h2 className="ouverture-title">
              Prête à sublimer <br/> votre regard ?
            </h2>
